...
.catch(error => console.log(error))
  ...
  <figure class="h-[200px] relative">
    <img class = "h-full w-full object-cover"
      ...
      alt="Shoes" />
      ${videoitem.others.posted_date?.length === 0? " ":`  <span class="absolute bottom-2 right-2 bg-black text-white rounded p-1">${getTimeString(videoitem.others.posted_date)}</span>`}
  ...
  ${videoitem.authors[0].verified === true?` <img class= "w-5" src="https://img.icons8.com/?size=48&id=yXOHowNYbgM5&format=png" />`:" "}
   </div>
   <p><button onclick="loadDetails('${videoitem.video_id}')" class="btn btn-sm btn-error"> details
   </button></p>
